  ...
  exports.plugin = function() {
    ...
    Permission = (function() {
      ...
      */
      ...
      function Permission(ownerResource, pLevel, featureFlags) {
        this.__owner = ownerResource;
        this.__pLevel = pLevel;
