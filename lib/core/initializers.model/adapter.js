    ...
    _plugin = function(skema, options) {
      ...
      */
      ...
      skema.methods.attach = function(name, actor, clbk) {
        var attachment, attachments, done, _i, _len, _results,
          _this = this;
        ...
        _results = [];
        for (_i = 0, _len = attachments.length; _i < _len; _i += 1) {
          attachment = attachments[_i];
          if ((this._configuration_.attach == null) || (this._configuration_.attach[attachment] == null)) {
            _results.push(done());
          } else {
            _results.push(this._configuration_.attach[attachment](this, actor, function(err, val) {
              if (err == null) {
