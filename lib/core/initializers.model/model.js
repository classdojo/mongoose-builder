...
(function() {
  ...
  */
  ...
  ModelInitializer = (function() {
    ModelInitializer.use = function(name, pkg) {
      this.__pkgs = this.__pkgs || {};
      return this.__pkgs[name] = pkg;
    };

    ModelInitializer.getPkg = function(name) {
      return this.__pkgs[name];
    };
    ...
    */
    ...
    function ModelInitializer(MongooseRelational, nodeBuilder, nodeManager, plugins) {
    ...
    */
    ...
    ModelInitializer.prototype._addRelationshipHooks = function(callback) {
      var MongooseRelational, mongooseRelational, permissionNode,
        _this = this;

      MongooseRelational = ModelInitializer.getPkg("Relational");
      mongooseRelational = new this.__MongooseRelational(this._schemas, this._models);
